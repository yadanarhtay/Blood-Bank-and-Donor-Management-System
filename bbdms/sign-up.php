...
<body>
 ...
 <div class="login px-4 mx-auto mw-100">
                            <h5 class="text-center mb-4">Donate Blood,Register Now</h5>
                            <form action="#" method="post"  name="signup" onsubmit="return checkpass();">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="mobileno" id="mobileno" required="true" placeholder="Mobile Number" maxlength="11" pattern="[0-9]+">
                                </div>
...
<?php }} ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" name="password" maxlength="15" id="password" required="10">
                                </div>
