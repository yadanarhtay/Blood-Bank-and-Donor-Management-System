				...
				<div class="contact-right-w3l appoint-form">
					...
					<form action="#" method="post" onsubmit="return checkpass();" name="changepassword">
						...
						<div class="form-group">
							...
							<input type="password" class="form-control" name="currentpassword" maxlength="15" id="currentpassword"required='true'>
						</div>
						<div class="form-group">
							<label for="recipient-phone" class="col-form-label">New Password</label>
							<input type="password" name="newpassword" maxlength="15" class="form-control" required="true">
						</div>
						<div class="form-group">
							<label for="recipient-phone" class="col-form-label">Confirm Password</label>
							<input type="password" class="form-control" name="confirmpassword" maxlength="15"s id="confirmpassword"  required='true'>
						</div>
